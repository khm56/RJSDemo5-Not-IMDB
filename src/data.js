...
import eddie_the_eagle from './eddie_the_eagle.jpg'
import emperors_new_groove from './emperors_new_groove.jpg'
import law_abiding_citizen from './law_abiding_citizen.jpg'
import lucky_number_slevin from './lucky_number_slevin.jpg' 
import stonehearst_asylum from './stonehearst_asylum.jpg'
import way_back from './way_back.jpg'
...
let movies = [
  ...
  },
  {
    ...
    name: "The Way Back",
    image: way_back,
    description: "Siberian gulag escapees travel 4,000 miles by foot to freedom in India."
  },
  {
    id: 4,
  ...
  },
  {
    ...
    description: "An Oxford graduate takes up a job in a mental asylum, only to discover that the 'revolutionary' new treatments are inhumane and that there is more going on than meets the eye."
  },
  {
    id: 6,
